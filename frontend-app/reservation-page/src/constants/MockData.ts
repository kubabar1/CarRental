...
export const currentUserDataResponseDTOMock = new UserDataResponseDTO(
    'Jan',
    'Kowalski',
    '123456789',
...
export const reservationStatusMock = new ReservationStatusResponseDTO('axd2awd4s1', 'Reservation accepted', true);
