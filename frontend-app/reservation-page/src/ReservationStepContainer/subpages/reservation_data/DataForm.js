...
class DataForm extends React.Component {
    ...
    optionsCityList = (city) => {
        return (
            <option key={city.id} name={city.city + '_' + city.id} id={city.city + '_' + city.id} value={city.id}>
                {city.city}
            </option>
        );
    };
    ...
    getMinDate = () => {
        ...
        return [tomorrow.getFullYear(), (mm > 9 ? '' : '0') + mm, (dd > 9 ? '' : '0') + dd].join('-');
    };
                ...
                <div className="shadow card mt-2">
                    ...
                    <div className="card-body">
                        <div className="form-group">
                            <label>City:</label>
                            <select
                                id="selected_city_data_form"
                                name="selected_city_data_form"
                                value={selected_city}
                        ...
                        <div className="form-group">
                            ...
                            <input
                                type="date"
                                id="reception_date_data_form"
                                name="reception_date_data_form"
                                min={this.getMinDate()}
                                max={maxReceptionDate ? maxReceptionDate : ''}
                                className="form-control"
                                onChange={this.handleReceiptDateInputChange}
                                className="form-control"
                                required
                                value={selected_reception_date}
                            />
                        </div>
                        <div className="form-group">
                            ...
                            <input
                                type="time"
                                id="reception_hour_data_form"
                                name="reception_hour_data_form"
                                className="form-control"
                                required
                                value={selected_reception_hour}
                        ...
                        <div className="form-group">
                            ...
                            <input
                                type="date"
                                id="return_date_data_form"
                                name="return_date_data_form"
                                min={minReturnDate ? minReturnDate : this.getMinDateReturn()}
                                className="form-control"
                                onChange={this.handleReturnDateInputChange}
                                className="form-control"
                                required
                                value={selected_return_date}
                            />
                        </div>
                        <div className="form-group">
                            ...
                            <input
                                type="time"
                                id="return_hour_data_form"
                                name="return_hour_data_form"
                                className="form-control"
                                required
                                value={selected_return_hour}
                                onChange={this.handleInputChange}
                            />
                        </div>
