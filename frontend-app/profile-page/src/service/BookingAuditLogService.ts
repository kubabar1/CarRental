...
export const getBookingsAuditLogsList = (page?: number, size?: number): Promise<Page<BookingAuditLogResponseDTO>> => {
    return fetchGet<Page<BookingAuditLogResponseDTO>>(PAGE_REQUEST(GET_BOOKINGS_AUDIT_LOGS_PATH, page, size));
};
