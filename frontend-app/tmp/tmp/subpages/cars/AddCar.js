...
export class AddCar extends React.Component {
    ...
    componentDidMount() {
        fetch('http://localhost:8080/CarRental/locations').then((response) => {
    ...
    listOptions = (optionElement) => {
        return (
            <option key={optionElement} name={optionElement} id={optionElement} value={optionElement}>
                {optionElement}
            </option>
        );
    };
    ...
    listOptionsCity = (optionElement) => {
        return (
            <option
                key={optionElement.id + '_' + optionElement.city}
                name={optionElement.id + '_' + optionElement.city}
                id={optionElement.id + '_' + optionElement.city}
    ...
    validate = () => {
        if (
            ...
            this.state.car_brand == null ||
            this.state.car_model == '' ||
            this.state.car_model == null ||
            this.state.car_daily_fee == '' ||
            this.state.car_daily_fee == null ||
            this.state.car_registration == '' ||
            this.state.car_registration == null ||
            this.state.car_location == '' ||
            this.state.car_location == null ||
            this.state.car_vehicle_status == '' ||
            this.state.car_vehicle_status == null ||
            this.state.car_body == '' ||
            this.state.car_body == null ||
            this.state.car_fuel_type == '' ||
            this.state.car_fuel_type == null ||
            this.state.car_power == '' ||
            this.state.car_power == null ||
            this.state.car_gearbox == '' ||
            this.state.car_gearbox == null ||
            this.state.car_doors_number == '' ||
            this.state.car_model == null ||
            this.state.car_seats_number == '' ||
            this.state.car_seats_number == null ||
            this.state.car_color == '' ||
            this.state.car_color == null ||
            this.state.car_description == '' ||
            this.state.car_description == null ||
            this.state.car_production_year == '' ||
            this.state.car_production_year == null ||
            this.state.car_image_name == '' ||
            this.state.car_image_name == null
        ) {
                        ...
                        <div className="row">
                            ...
                            <div className="ml-4 mt-3 col-md-3">
                                <input
                                    ...
                                    name="car_daily_fee"
                                    required
                                    value={this.state.car_daily_fee}
                                    onChange={this.handleInputChange}
                                />
                            </div>
                        </div>
                        ...
                        <div className="row">
                            ...
                            <div className="ml-4 mt-3 col-md-3">
                                <select
                                    ...
                                    onChange={this.handleInputChange}
                                >
                                    <option key="dispabled_role" name="disabled_role" value="" disabled="disabled">
                                        Choose car location
                                    </option>
                        ...
                        <div className="row">
                            ...
                            <div className="ml-4 mt-4  col-md-3">
                                <input
                                    type="checkbox"
                                    name="car_best_offer"
                                    checked={this.state.car_best_offer}
                                    onChange={this.handleInputChange}
                                />
                            </div>
                        </div>
                        ...
                        <div className="row">
                            ...
                            <div className="ml-4 mt-3 col-md-3">
                                <select
                                    ...
                                    className="form-control"
                                    required
                                    value={this.state.car_vehicle_status}
                                    onChange={this.handleInputChange}
                                >
                        ...
                        <div className="row">
                            ...
                            <div className="ml-4 mt-3 col-md-3">
                                <input
                                    ...
                                    required
                                    value={this.state.car_production_year}
                                    onChange={this.handleInputChange}
                                />
                            </div>
                        </div>
                        ...
                        <div className="row">
                            ...
                            <div className="ml-4 mt-3 col-md-3">
                                <select
                                    ...
                                    className="form-control"
                                    required
                                    value={this.state.car_fuel_type}
                                    onChange={this.handleInputChange}
                                >
                                    <option key="dispabled_role" name="disabled_role" value="" disabled="disabled">
                                        Choose fuel type
                    ...
                    <div className="form-group">
                        <div className="row">
                            ...
                            <div className="ml-4 mt-4 col-md-3">
                                <input
                                    type="checkbox"
                                    name="car_front_wheels"
                                    checked={this.state.car_front_wheels}
                                    onChange={this.handleInputChange}
                                />
                            </div>
                        </div>
                        ...
                        <div className="row">
                            ...
                            <div className="ml-4 mt-3 col-md-3">
                                <input
                                    ...
                                    required
                                    value={this.state.car_doors_number}
                                    onChange={this.handleInputChange}
                                />
                            </div>
                        </div>
                        ...
                        <div className="row">
                            ...
                            <div className="ml-4 mt-3 col-md-3">
                                <input
                                    type="number"
                                    className="form-control"
                                    name="car_seats_number"
                                    required
                                    value={this.state.car_seats_number}
                                    onChange={this.handleInputChange}
                                />
                            </div>
                        </div>
                        ...
                        <div className="row">
                            ...
                            <div className="ml-4 mt-4  col-md-3">
                                <input
                                    type="checkbox"
                                    name="car_metallic"
                                    checked={this.state.car_metallic}
                                    onChange={this.handleInputChange}
                                />
                            </div>
                        </div>
    ...
    showError = (message) => {
        return <div className="my-3 alert alert-danger">{message}</div>;
    };
