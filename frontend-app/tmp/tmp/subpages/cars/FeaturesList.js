...
export class FeaturesList extends React.Component {
    ...
    loadEqpList = () => {
        fetch('http://localhost:8080/CarRental/equipmentlist').then((response) => {
    ...
    renderRow = (eqp) => {
        return (
            <tr key={eqp.equipmentCode}>
                <td>
                    <button
                        onClick={() => this.deleteEquipment(eqp.equipmentCode)}
            ...
            <form onSubmit={this.handleSubmitAddEquipment}>
                ...
                <div className="mt-3 ml-3 col-md-5 mx-auto">
                    <input
                        ...
                        required
                        onChange={this.handleEqCodeChange}
                ...
                <div className="mt-3 ml-3 col-md-5 mx-auto">
                    <input
                        name="eqp_description"
                        type="text"
                        className="form-control"
                        required
                        onChange={this.handleEqDescChange}
                    />
                </div>
