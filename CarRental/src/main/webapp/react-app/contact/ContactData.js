      ...
      <div className="container col-md-3">
        <div id="contacts-data" className="card shadow">
          ...
          <div className="card-body">
            <i className="fas fa-map-marker-alt" style={{fontSize:18}}> Warszawa 12-345 <br></br> ul. Test 23</i><br></br>
            <i className="fa fa-phone" style={{fontSize:18}}> 423 232 123</i><br></br>
            <i className="fa fa-mobile" style={{fontSize:18}}> 948 132 423</i><br></br>
