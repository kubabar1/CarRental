...
public class BookingController {
  ...
  @RequestMapping(
      method = RequestMethod.GET,
      params = {"page", "number"})
  public Page<Booking> getAllBookingsForPage(
  ...
  @RequestMapping(
      ...
      method = RequestMethod.GET,
      params = {"page", "number"})
  public Page<Booking> getReservedBookingsForPage(
      @RequestParam(value = "page") int page, @RequestParam(value = "number") int number) {
  ...
  @RequestMapping(
      ...
      method = RequestMethod.GET,
      params = {"page", "number"})
  public Page<Booking> getRentedBookingsForPage(
      @RequestParam(value = "page") int page, @RequestParam(value = "number") int number) {
  ...
  @RequestMapping(
      ...
      method = RequestMethod.GET,
      params = {"page", "number"})
  public Page<Booking> getAllUserBookingsForPage(
  ...
  @RequestMapping(
      value = {"/reserved/{userId}"},
      method = RequestMethod.GET,
      params = {"page", "number"})
  public Page<Booking> getReservedUserBookingsForPage(
      @PathVariable Long userId,
      @RequestParam(value = "page") int page,
      @RequestParam(value = "number") int number) {
  ...
  @RequestMapping(
      ...
      method = RequestMethod.GET,
      params = {"page", "number"})
  public Page<Booking> getRentedUserBookingsForPage(
      @PathVariable Long userId,
      @RequestParam(value = "page") int page,
      @RequestParam(value = "number") int number) {
  ...
  @RequestMapping(
      ...
      method = RequestMethod.GET,
      params = {"page", "number"})
  public Page<Booking> getCanceledBookingsForPage(
      @RequestParam(value = "page") int page, @RequestParam(value = "number") int number) {
